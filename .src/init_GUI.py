...
def init_GUI(self):
    ...
    self.tabview = customtkinter.CTkTabview(self, width=300, height=500)
    ...
    self.textbox.grid(row=0, column=3, padx=(20, 0), pady=(20, 0), sticky="nsew", rowspan=3)
    ...
    self.analyze_button_1.grid(row=3, column=3, padx=(20, 20), pady=(20, 20), sticky="nsew")
    # 오른쪽 아래 exit button
